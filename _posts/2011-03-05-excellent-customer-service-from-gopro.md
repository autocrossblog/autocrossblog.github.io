...
So I applied the firmware update, but something during the process failed and the camera ended up â€œbricking" which basically means it wouldn't work. You couldn't power it on, you couldn't use it, nothing, it was as useful as a brick. Since I got the camera for xmas it was still under warranty so I contacted GoPro about getting it fixed, while it took a bit of back and forth via email with their customer service reps, they provided me with an RMA number to send it in.
